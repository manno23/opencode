...
readonly SCHEMA_DIR="$ROOT_DIR/sdk/schema"
...
bundle_specification() {
    ...
    run_command \
        "npx redocly bundle sdk/schema/openapi.json -o sdk/schema/openapi.bundled.json" \
        "Bundling spec"
...
generate_types() {
    ...
    run_command \
        "oapi-codegen -generate types -package opencode sdk/schema/openapi.bundled.json > '$temp_file'" \
