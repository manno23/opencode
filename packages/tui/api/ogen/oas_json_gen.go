...
var jsonFieldsNameOfApp = [4]string{
	0: "hostname",
	1: "git",
	2: "path",
	3: "time",
...
// Encode implements json.Marshaler.
func (s *AppPath) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *AppPath) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("config")
		e.Str(s.Config)
	}
...
var jsonFieldsNameOfAppPath = [5]string{
	0: "config",
	1: "data",
	2: "root",
	3: "cwd",
...
// Decode decodes AppPath from json.
func (s *AppPath) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode AppPath to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode AppPath")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfAppPath) {
					name = jsonFieldsNameOfAppPath[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *AppPath) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *AppPath) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *AppTime) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *AppTime) encodeFields(e *jx.Encoder) {
	{
...
var jsonFieldsNameOfAppTime = [1]string{
	0: "initialized",
}

// Decode decodes AppTime from json.
func (s *AppTime) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode AppTime to nil")
	}
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode AppTime")
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s *AppTime) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *AppTime) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
var jsonFieldsNameOfModel = [11]string{
	0:  "id",
	1:  "name",
	2:  "release_date",
	3:  "attachment",
...
// Encode encodes SessionChatReq as json.
func (o OptSessionChatReq) Encode(e *jx.Encoder) {
	if !o.Set {
		return
	}
	o.Value.Encode(e)
...
// Decode decodes SessionChatReq from json.
func (o *OptSessionChatReq) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptSessionChatReq to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptSessionChatReq) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptSessionChatReq) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes SessionChatReqTools as json.
func (o OptSessionChatReqTools) Encode(e *jx.Encoder) {
	if !o.Set {
		return
	}
	o.Value.Encode(e)
...
// Decode decodes SessionChatReqTools from json.
func (o *OptSessionChatReqTools) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptSessionChatReqTools to nil")
	}
	o.Set = true
	o.Value = make(SessionChatReqTools)
	if err := o.Value.Decode(d); err != nil {
		return err
	}
	return nil
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptSessionChatReqTools) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptSessionChatReqTools) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
// Encode implements json.Marshaler.
func (s *SessionChatOK) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *SessionChatOK) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("info")
		s.Info.Encode(e)
	}
...
var jsonFieldsNameOfSessionChatOK = [2]string{
	0: "info",
	1: "parts",
}

// Decode decodes SessionChatOK from json.
func (s *SessionChatOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SessionChatOK to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode SessionChatOK")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSessionChatOK) {
					name = jsonFieldsNameOfSessionChatOK[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *SessionChatOK) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SessionChatOK) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *SessionChatReq) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *SessionChatReq) encodeFields(e *jx.Encoder) {
	{
		if s.MessageID.Set {
			e.FieldStart("messageID")
...
var jsonFieldsNameOfSessionChatReq = [7]string{
	0: "messageID",
	1: "providerID",
	2: "modelID",
	3: "agent",
...
// Decode decodes SessionChatReq from json.
func (s *SessionChatReq) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SessionChatReq to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "parts":
			requiredBitSet[0] |= 1 << 6
			if err := func() error {
				s.Parts = make([]SessionChatReqPartsItem, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem SessionChatReqPartsItem
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.Parts = append(s.Parts, elem)
		...
		return errors.Wrap(err, "decode SessionChatReq")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfSessionChatReq) {
					name = jsonFieldsNameOfSessionChatReq[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *SessionChatReq) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SessionChatReq) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes SessionChatReqPartsItem as json.
func (s SessionChatReqPartsItem) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}

func (s SessionChatReqPartsItem) encodeFields(e *jx.Encoder) {
	switch s.Type {
	case TextPartInputSessionChatReqPartsItem:
		e.FieldStart("type")
		e.Str("text")
		{
			s := s.TextPartInput
	...
	case FilePartInputSessionChatReqPartsItem:
		e.FieldStart("type")
		e.Str("file")
		{
			s := s.FilePartInput
	...
	case AgentPartInputSessionChatReqPartsItem:
		e.FieldStart("type")
		e.Str("agent")
		{
			s := s.AgentPartInput
...
// Decode decodes SessionChatReqPartsItem from json.
func (s *SessionChatReqPartsItem) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SessionChatReqPartsItem to nil")
	}
	// Sum type discriminator.
	if typ := d.Next(); typ != jx.Object {
		return errors.Errorf("unexpected json type %q", typ)
...
// MarshalJSON implements stdjson.Marshaler.
func (s SessionChatReqPartsItem) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SessionChatReqPartsItem) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s SessionChatReqTools) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields implements json.Marshaler.
func (s SessionChatReqTools) encodeFields(e *jx.Encoder) {
	for k, elem := range s {
		e.FieldStart(k)
...
// Decode decodes SessionChatReqTools from json.
func (s *SessionChatReqTools) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SessionChatReqTools to nil")
	}
	m := s.init()
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		var elem bool
		...
		return errors.Wrap(err, "decode SessionChatReqTools")
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s SessionChatReqTools) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SessionChatReqTools) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
